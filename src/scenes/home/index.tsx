...
function Home({ setSelectedPage }: Props) {
  ...
  // "md" is a media query and we are only applying full height and no padding only when above medium screens (min-width:1060px)
  return (
    <section id="home" className="gap-16 bg-gray-20 py-10 md:h-full md:pd-0">
      {/* IMAGE AND MAIN HEADER */}
      <motion.div
        className="md:flex mx-auto w-5/6 items-center justify-center md:h-5/6"
        onViewportEnter={() => setSelectedPage(SelectedPage.Home)} // allows us to perform a method when we are at this section
      >
        {/* MAIN HEADER */}
